...
class BattlePetsControllerAuthTest < ActionController::TestCase
  ...
  test "index should get unauthorized" do
    get :index

    assert_redirected_to @redirect_url
  end

  test "new should get unauthorized" do
    get :new

    assert_redirected_to @redirect_url
  end

  test "create should get unauthorized" do
  ...
  test "show should get unauthorized" do
    get :show, :id => 1
    
    assert_redirected_to @redirect_url
  end

  test "edit should get unauthorized" do
    get :edit, :id => 1
    
    assert_redirected_to @redirect_url
  end

  test "update should get unauthorized" do
